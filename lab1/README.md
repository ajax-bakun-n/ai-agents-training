...
Experienced:
1. Complete beginner tasks but as a helm deployment in a Kubernetes cluster
...
Max:
1. Complete experienced tasks with gateway API https://agentgateway.dev/docs/kubernetes/main/about/gateway-api/

Research:
1. Evaluate the ADR of the S&T project: DevOps Bot/Agent
   Your questions about the project, suggest improvements and solutions
